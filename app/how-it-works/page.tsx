    ...
    <div className="relative min-h-screen bg-[#0f0f0f] flex flex-col overflow-hidden">
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center px-4 sm:px-6 pt-36 pb-24">
        ...
        <div className="text-center mb-16 sm:mb-24">
          ...
          <p className="mt-6 text-[#888] text-base sm:text-lg max-w-xl mx-auto leading-relaxed">
        ...
        <div className="w-full max-w-3xl flex flex-col items-center">
          ...
          <div className="w-full grid grid-cols-2 gap-4 sm:gap-6">
            ...
            {/* ASME Drawing Input */}
            <div className="flex flex-col items-center text-center gap-3 sm:gap-4 border border-[#262626] bg-[#161616] p-4 sm:p-6">
              <div className="w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center border border-[#262626] bg-[#0f0f0f] flex-shrink-0">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 sm:w-6 sm:h-6 text-[#00ff41]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 0 0-9-9Z" />
                </svg>
              </div>
              <div>
                <p className="text-xs sm:text-sm font-semibold text-[#e8e8e8] leading-tight">ASME Drawing</p>
                <p className="hidden sm:block font-mono text-xs text-[#555] mt-1 leading-relaxed">Drop in an ASME drawing and we pull every dimension out of it</p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center text-center gap-3 sm:gap-4 border border-[#262626] bg-[#161616] p-4 sm:p-6">
              ...
              <div>
                <p className="text-xs sm:text-sm font-semibold text-[#e8e8e8] leading-tight">Direct Prompt</p>
                <p className="hidden sm:block font-mono text-xs text-[#555] mt-1 leading-relaxed">Just describe what you want. No CAD background required</p>
              </div>
            </div>
          ...
          <div className="relative w-full h-10 sm:h-14 flex-shrink-0 overflow-hidden">
            <div className="absolute left-[25%] top-0 bottom-0 w-px bg-[#262626]" />
            <div className="absolute right-[25%] top-0 bottom-0 w-px bg-[#262626]" />
            <div className="absolute bottom-0 left-[25%] right-[25%] h-px bg-[#262626]" />
          </div>

          {/* ── Processing Layer ── */}
          <div className="w-full border border-[#262626] bg-[#161616] p-5 sm:p-8">
            <div className="text-center mb-5 sm:mb-6">
              <p className="font-mono text-[10px] uppercase tracking-[0.3em] text-[#00ff41] mb-1">Under the hood</p>
          ...
          <div className="relative flex flex-col items-center h-10 sm:h-14 flex-shrink-0">
            ...
            <svg className="w-4 h-3 -mt-px" viewBox="0 0 16 10" fill="none">
              <path d="M8 10L0 0h16L8 10z" fill="#262626" />
            </svg>
          </div>

          {/* ── Output ── */}
          <div className="w-full sm:w-2/3 border border-[#00ff41]/30 bg-[#161616] p-5 sm:p-7 flex flex-col items-center text-center gap-3">
            <div className="w-12 h-12 flex items-center justify-center border border-[#00ff41]/30 bg-[#0f0f0f]">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-[#00ff41]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="m21 7.5-9-5.25L3 7.5m18 0-9 5.25m9-5.25v9l-9 5.25M3 7.5l9 5.25M3 7.5v9l9 5.25m0-9v9" />
              </svg>
            </div>
            <div>
              <p className="font-mono text-[10px] uppercase tracking-[0.3em] text-[#00ff41] mb-1">Output</p>
              <p className="text-base sm:text-lg font-bold text-[#e8e8e8]">Your Model in Onshape</p>
              <p className="font-mono text-xs text-[#555] mt-1.5 leading-relaxed max-w-xs mx-auto">
        ...
        <div className="w-full max-w-3xl flex flex-col items-center mt-24 sm:mt-32">
          ...
          {/* Translation card */}
          <div className="w-full border border-[#262626] bg-[#161616] p-6 sm:p-8 mb-4">
            <div className="flex items-start gap-4 mb-5">
              <div className="w-10 h-10 flex items-center justify-center border border-[#262626] bg-[#0f0f0f] flex-shrink-0">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-[#00ff41]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 21 3 16.5m0 0L7.5 12M3 16.5h13.5m0-13.5L21 7.5m0 0L16.5 12M21 7.5H7.5" />
                </svg>
              </div>
              <div>
                <p className="font-mono text-[10px] uppercase tracking-[0.3em] text-[#00ff41] mb-1">Cross-Platform</p>
                <h3 className="text-base sm:text-lg font-bold text-[#e8e8e8]">Universal CAD Translation</h3>
                <p className="font-mono text-xs text-[#555] mt-1.5 leading-relaxed">
            ...
            <div className="flex items-center justify-center gap-2 sm:gap-3 flex-wrap mt-4">
              {["SolidWorks", "Fusion 360", "CATIA", "FreeCAD"].map((sw) => (
                <div
                  key={sw}
                  className="px-3 py-1.5 font-mono text-xs text-[#555] border border-[#262626] bg-[#0f0f0f]"
                >
                  {sw}
                </div>
              ))}
              ...
              <div className="px-3 py-1.5 font-mono text-xs text-[#00ff41] border border-[#00ff41]/40 bg-[#0f0f0f]">
                Any target platform
              </div>
            </div>
          </div>
          ...
          <div className="w-full border border-[#262626] bg-[#161616] p-6 sm:p-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="font-mono text-[10px] uppercase tracking-[0.3em] text-[#00ff41] mb-1">Phase 1 — Coming Soon</p>
                <h3 className="text-base sm:text-lg font-bold text-[#e8e8e8]">Onshape Native Integration</h3>
                <p className="font-mono text-xs text-[#555] mt-1.5 leading-relaxed">
                ...
                <p className="font-mono text-xs text-[#555] mt-2 leading-relaxed">
        ...
        <div className="mt-14 flex flex-col items-center gap-4 text-center">
          <p className="font-mono text-xs uppercase tracking-[0.3em] text-[#555]">Want early access?</p>
          <Link
            href="/signup"
            className="px-8 py-3.5 bg-[#00ff41] font-mono text-xs uppercase tracking-widest text-black hover:bg-[#00cc33] transition-colors duration-200"
          >
            Join the Waitlist
          </Link>
        </div>
