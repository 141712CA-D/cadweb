...
export default function DevBanner() {
  ...
  return (
    <div className={`fixed top-0 left-0 right-0 z-[60] h-8 flex items-center justify-center bg-[#f8fafc] border-b border-[#dbe6f5] transition-all duration-300 ${hidden ? "-translate-y-full opacity-0 pointer-events-none" : "translate-y-0 opacity-100"}`}>
