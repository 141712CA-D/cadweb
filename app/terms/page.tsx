        ...
        <div className="space-y-10 text-sm text-[#1E293B]/60 leading-relaxed">
          ...
          <section>
            ...
            <p className="mt-3">
              ...
              <strong> waitlistSynced</strong>). We also refresh hashed dedup data in browser storage and mark the refresh
              with a functional cookie called <strong>waitlistPrepared</strong>. The background sync ensures our database remains synchronized with our 
